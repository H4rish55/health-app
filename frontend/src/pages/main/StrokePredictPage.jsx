      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-200/90 text-lg max-w-2xl mx-auto leading-relaxed">
            Advanced neural networks analyze risk factors to predict stroke likelihood with 94% accuracy
          </p>
        ...
        <div className="bg-slate-900/70 border border-white/10 rounded-2xl p-8 shadow-2xl">
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Hypertension */}
              <div>
                <label htmlFor="hypertension" className="block text-sm font-medium text-gray-300 mb-2">Hypertension</label>
                <select
                  id="hypertension"
                  value={hypertension}
              ...
              {/* Heart Disease */}
              <div>
                <label htmlFor="heartDisease" className="block text-sm font-medium text-gray-300 mb-2">Heart Disease</label>
                <select
                  id="heartDisease"
                  value={heartDisease}
              ...
              {/* Ever Married */}
              <div>
                <label htmlFor="everMarried" className="block text-sm font-medium text-gray-300 mb-2">Ever Married</label>
                <select
                  id="everMarried"
                  value={everMarried}
              ...
              {/* Work Type */}
              <div>
                <label htmlFor="workType" className="block text-sm font-medium text-gray-300 mb-2">Work Type</label>
                <select
                  id="workType"
                  value={workType}
              ...
              {/* Residence Type */}
              <div>
                <label htmlFor="residenceType" className="block text-sm font-medium text-gray-300 mb-2">Residence Type</label>
                <select
                  id="residenceType"
                  value={residenceType}
              ...
              {/* Avg Glucose */}
              <div>
                <label htmlFor="avgGlucoseLevel" className="block text-sm font-medium text-gray-300 mb-2">
              ...
              {/* BMI */}
              <div>
                <label htmlFor="bmi" className="block text-sm font-medium text-gray-300 mb-2">BMI</label>
                <input
                  id="bmi"
                  type="number"
                  value={bmi}
              ...
              {/* Smoking Status — now aligned to fill the BMI row gap */}
              <div>
                <label htmlFor="smokingStatus" className="block text-sm font-medium text-gray-300 mb-2">
                  Smoking Status
                </label>
                <select
                  id="smokingStatus"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-slate-900/70 border border-white/10">
                  ...
                  <p className="text-2xl font-bold mt-1">
                    {prediction === 1 ? "Stroke Risk detected" : "No Stroke Risk"}
                  </p>
                </div>
                <div className="p-4 rounded-lg bg-slate-900/70 border border-white/10">
